<<<<<<< HEAD:projeto_completo/components/dashboards.py
...
@app.callback([Output("dropdown-investimento", "options"),
    Output("dropdown-investimento", "value"),
    Output("p-investimento-dashboards", "children")],
...
@app.callback(
    ...
    Input("store-receitas", "data"),
    Input("store-investimentos", "data")])
def saldo_total(despesas, receitas, investimentos):
...
>>>>>>> 23caa3f101c976c15d75672143eb8a5bdcd9fb77:components/dashboards.py
    return fig